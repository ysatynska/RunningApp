...
import {welcomeText, sharedStyles} from "../helperComponents/styles.js";
...
export default function Welcome ({navigation}) {
  ...
  return (
      <View style={sharedStyles.justifyContainer}>
        <Image source={require('../images/giphy.gif')} style={[sharedStyles.image, {transform: [{ scaleX: -1 }]}]}/>
        <Animated.Text style={[welcomeText, { opacity: fadeAnimText, marginVertical: 10 }]}> Welcome! </Animated.Text>
